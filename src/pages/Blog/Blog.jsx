  ...
  return (
    <section class="container" id="blogs">
      <div class="blogs-content">
        ...
        <div class="blogs">
          <div class="blog">
            <img src="/src/assets/port6.jpg" alt="" />
            <div class="blog-text">
          ...
          <div class="blog">
            <img src="/src/assets/blog2.jpg" alt="" />
            <div class="blog-text">
          ...
          <div class="blog">
            <img src="/src/assets/blog3.jpg" alt="" />
            <div class="blog-text">
          ...
          <div class="blog">
            <img src="/src/assets/port1.jpg" alt="" />
            <div class="blog-text">
          ...
          <div class="blog">
            <img src="/src/assets/port3.jpg" alt="" />
            <div class="blog-text">
